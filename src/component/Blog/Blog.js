    ...
    return (
        <div className="blog-container container py-5">
            ...
            <div className="blog-section">
                ...
                <p>Necessary things are things that may not be vital to our preferences but important for our existence. To sum it up they are food, clothing and shelter. Without any of the three we will have trouble living the normal life or even living at all.</p>
            </div>
            <div className="blog-section">
